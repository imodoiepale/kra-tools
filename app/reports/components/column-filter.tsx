...
export function ColumnFilter({ 
  ...
  const getButtonColor = (id: string) => {
    switch(id) {
      case "paye": return "bg-blue-100 hover:bg-blue-200 text-blue-800"
      case "housingLevy": return "bg-purple-100 hover:bg-purple-200 text-purple-800"
      case "nita": return "bg-green-100 hover:bg-green-200 text-green-800"
      case "shif": return "bg-orange-100 hover:bg-orange-200 text-orange-800"
      case "nssf": return "bg-red-100 hover:bg-red-200 text-red-800"
      default: return ""
    }
  }
            ...
            <CommandGroup>
              {columns.map((column) => (
                <CommandItem
                  ...
                  className={cn(
                    selectedColumns.includes(column.id) && getButtonColor(column.id)
                  )}
                >
                  <Check
                    className={cn(
