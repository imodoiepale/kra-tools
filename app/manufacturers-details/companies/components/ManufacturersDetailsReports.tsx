            ...
            <Table className="text-[11px] text-black border-collapse w-full">
              <TableHeader className="bg-gray-50">
                <TableRow className="border-b border-gray-200">
                  ...
                  <TableHead className="sticky top-0 bg-white text-center text-[12px] text-black font-bold border-r border-gray-200 py-2 px-3">Actions</TableHead>
                </TableRow>
                {showStatsRows && (
                  <>
                    <TableRow className="bg-gray-100">
                      ...
                      {Object.entries(visibleColumns).map(([column, isVisible]) => {
                        ...
                        return (
                          <TableCell key={`complete-${column}`} className="text-center text-[10px] border border-r">
                    ...
                    <TableRow className="bg-gray-50">
                      ...
                      {Object.entries(visibleColumns).map(([column, isVisible]) => {
                        ...
                        return (
                          <TableCell key={`missing-${column}`} className="text-center text-[10px] border border-r">
              ...
              <TableBody>
                {isLoading ? (
                  <TableRow>
                    <TableCell colSpan={Object.values(visibleColumns).filter(Boolean).length + 2} className="h-[200px] border border-r">
