...
const renderFileLink = (link: string | null) => {
    if (!link) return <span className="text-red-500 font-bold">Missing</span>;
...
export default function PentasoftExtractionReports() {
    // State variables
                                            ...
                                            <Table>
                                                <TableHeader>
                                                    <TableRow>
                                                        ...
                                                        {[
                                                            { label: 'Payslip', key: 'Payslip_Link' },
                                                            { label: 'PAYE', key: 'PAYE_Link' },
                                                            { label: 'PAYE CSV', key: 'PAYE_CSV_Link' },
                                                            { label: 'NSSF', key: 'NSSF_Link' },
                                                            { label: 'NSSF Excel', key: 'NSSF_Excel_Link' },
                                                            { label: 'NHIF', key: 'NHIF_Link' },
                                                            { label: 'NHIF Excel', key: 'NHIF_Excel_Link' },
                                                            { label: 'SHIF', key: 'SHIF_Link' },
                                                            { label: 'SHIF Excel', key: 'SHIF_Excel_Link' },
                                                            { label: 'Housing Levy', key: 'Housing_Levy_Link' },
                                                            { label: 'Housing Levy CSV', key: 'Housing_Levy_CSV_Link' },
                                                            { label: 'Payslips', key: 'Payslips_Link' },
                                                            { label: 'Control Total', key: 'Control_Total_Link' },
                                                            { label: 'Payroll Recon', key: 'Payroll_Recon_Link' },
                                                            { label: 'Payroll Summary', key: 'Payroll_Summary_Link' },
                                                            { label: 'Payroll Summary Excel', key: 'Payroll_Summary_Excel_Link' },
                                                            { label: 'Bank List', key: 'Bank_List_Link' },
                                                            { label: 'Cash List', key: 'Cash_List' },
                                                            { label: 'MPESA List', key: 'MPESA_List' },
                                                            { label: 'NITA List', key: 'NITA_List' },
                                                        ].map(({ label }) => (
                                                            <TableHead className="text-xs text-center" key={label}>{label}</TableHead>
                                                        ))}
                                                    </TableRow>
                                                </TableHeader>
                                                    ...
                                                    {reports.map((report, index) => (
                                                        <TableRow key={report.ID}>
                                                            ...
                                                            {[
                                                                ...
                                                                <TableCell key={key}>{renderFileLink(report[key])}</TableCell>
                                                            ))}
                                                        </TableRow>
                                                    ))}
                                                </TableBody>
