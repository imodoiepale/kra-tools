...
//     console.log(`Rendering TaxTypeTable for ${taxType}`, { companies: companies.length, statusField, fromField, toField });
...
//     }, [filteredData, taxType, statusField, fromField, toField]);
