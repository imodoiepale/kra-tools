                    ...
                    {loading ? (
                        ...
                        >
                            ...
                            {TAX_TYPES.map(tax => {
                                ...
                                const documentPath = record.payment_slips_documents[slipType]
                                    ...
                                    <>
                                        ...
                                        <TableCell>
                                            <DocumentUploadDialog
                                                documentType={slipType}
                                                recordId={record.id}
                                                onUpload={(file) => handleDocumentUpload(record.id, file, slipType)}
                                                onDelete={() => handleDocumentDelete(record.id, slipType)}
